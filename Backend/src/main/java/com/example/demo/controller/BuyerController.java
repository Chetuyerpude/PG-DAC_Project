...
public class BuyerController {
	...
	public List<Product>getAllAvbProducts() 
	{
		return productService.searchByProductNameForSell();
	}
	...
	public String updatebuyer(@RequestBody User user,@PathVariable Long id )
	{
