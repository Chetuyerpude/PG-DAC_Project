...
public class ProductServiceImpl implements ProductService {
	...
	public String deleteProductAfterExecution(long id,Long userid) {
		...
		executeOrderForAnotherUser(id,userid,transaction.getTrnNumber());
	...
	@Override
	public void executeOrderForAnotherUser(Long id, Long userid,String trnNumber) {
		Product product=
		...
		userTransaction.setTrnNumber(trnNumber);
